...
async def generate_quiz(
    ...
    prompt = (
        ...
        f"ISO Topics/Subjects:\n{json.dumps(context, indent=2)}\n\n"
        f"{avoid_block}"
        "The input provided above is a list of topics or subject names for an ISO-centric platform. "
        "Your goal is to combine these topics into a cohesive, professional quiz. "
        "Treat each item in the context as an ISO subject matter area. "
        "Leverage your deep expertise as an ISO consultant to generate technical questions about "
        "specific clauses, compliance requirements, audits, and management system implementation "
        "directly related to these topics. "
        "Do NOT ask generic questions or questions about the topic's identity (e.g., 'What is the industry focus?'). "
        "Focus strictly on professional-level, specialized ISO knowledge and practical application. "
